...
const CONFIG_SECTIONS: ConfigSectionMeta[] = [
    ...
    fields: [
      {
        ...
        description: "Plugin enable/disable configuration (JSON)",
        type: "object",
        required: false,
        advanced: true,
        sensitive: false,
    ...
    fields: [
      {
        key: "session.dmScope",
        label: "DM Scope",
        description: "How to scope direct message sessions",
        type: "select",
        required: false,
        options: [
    ...
    fields: [
      {
        ...
        description: "Native command execution policy",
        type: "select",
        required: false,
        options: [
      ...
      },
      {
        ...
        label: "Allow Restart",
        description: "Allow the agent to restart itself",
        type: "boolean",
        required: false,
        defaultValue: true,
        advanced: false,
      ...
      },
      {
        ...
        label: "Owner Display",
        description: "How to display the owner",
        type: "select",
        required: false,
        options: [
          { label: "Raw", value: "raw" },
  ...
  },
  {
    ...
    fields: [
      {
        key: "skills.install.nodeManager",
        label: "Node Manager",
        description: "Package manager for skill installation",
        type: "select",
        required: false,
        options: [
          { label: "Bun", value: "bun" },
  ...
  },
  {
    ...
    fields: [
      ...
      },
      {
        ...
        description: "Redact API keys and tokens from logs",
        type: "boolean",
        required: false,
        defaultValue: true,
        advanced: true,
    ...
    fields: [
      {
        ...
        description: "Enable internal hook system",
        type: "boolean",
        required: false,
        defaultValue: true,
        advanced: true,
      ...
      },
      {
        ...
        label: "Hook Entries",
        description: "Hook configuration entries (JSON)",
        type: "object",
        required: false,
        advanced: true,
        sensitive: false,
    ...
    fields: [
      {
        key: "cron.enabled",
        label: "Enabled",
        description: "Enable cron/scheduled tasks",
        type: "boolean",
        required: false,
        defaultValue: true,
        advanced: true,
      ...
      {
        key: "cron.maxConcurrent",
        label: "Max Concurrent",
        description: "Maximum concurrent cron jobs",
        type: "number",
        required: false,
        defaultValue: 5,
        advanced: true,
    ...
    fields: [
      {
        key: "memory.enabled",
        label: "Enabled",
        description: "Enable agent memory system",
        type: "boolean",
        required: false,
        defaultValue: true,
        advanced: true,
    ...
    fields: [
      {
        ...
        description: "MCP server definitions (JSON)",
        type: "object",
        required: false,
        advanced: true,
        sensitive: false,
    ...
    fields: [
      {
        ...
        description: "TTS provider settings (JSON)",
        type: "object",
        required: false,
        advanced: true,
        sensitive: false,
  ...
  },
  {
    ...
    fields: [
      {
        key: "routing.defaultAgent",
        label: "Default Agent",
        description: "Default agent for unclassified messages",
        type: "text",
        required: false,
        advanced: true,
        sensitive: false,
      },
      {
        key: "routing.rules",
        label: "Routing Rules",
        description: "Message routing rules (JSON)",
        type: "object",
        required: false,
        advanced: true,
        sensitive: false,
    ...
    fields: [
      {
        ...
        description: "Secret provider settings (JSON)",
        type: "object",
        required: false,
        advanced: true,
        sensitive: true,
    ...
    fields: [
      {
        key: "auth.profiles",
        label: "Auth Profiles",
        description: "Authentication profiles (JSON)",
        type: "object",
        required: false,
        advanced: true,
        sensitive: true,
    ...
    fields: [
      {
        ...
        options: [
          ...
          { label: "Auto-approve Low Risk", value: "auto-low" },
          { label: "Auto-approve All", value: "auto-all" },
        ],
        defaultValue: "auto-low",
        advanced: true,
        sensitive: false,
      },
      {
  ...
  },
  {
    ...
    fields: [
      ...
      {
        key: "diagnostics.stuckSessionWarnMs",
        label: "Stuck Session Warning (ms)",
        description: "Warn if session is stuck for this many ms",
        type: "number",
        required: false,
        defaultValue: 120000,
        advanced: true,
    ...
    fields: [
      {
        ...
        description: "Shell environment variables (JSON)",
        type: "object",
        required: false,
        advanced: true,
        sensitive: false,
      },
      {
        ...
        description: "Custom environment variables (JSON)",
        type: "key-value",
        required: false,
        advanced: true,
        sensitive: false,
  ...
  },
  {
    ...
    fields: [
      {
        key: "wizard.lastRunAt",
        label: "Last Run At",
        description: "ISO timestamp of last wizard run",
        type: "text",
        required: false,
        advanced: true,
        sensitive: false,
      ...
      {
        key: "wizard.lastRunVersion",
        label: "Last Run Version",
        description: "OpenClaw version at last wizard run",
        type: "text",
        required: false,
        advanced: true,
        sensitive: false,
    ...
    fields: [
      {
        ...
        description: "Version that last modified the config",
        type: "text",
        required: false,
        advanced: true,
        sensitive: false,
